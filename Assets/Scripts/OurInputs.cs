...
public partial class @OurInputs: IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        {
            ...
            ""actions"": [
                ...
                },
                {
                    ""name"": ""Pause"",
                    ""type"": ""Button"",
                    ""id"": ""68bca980-718d-4c9c-8639-6fdc83202b3e"",
                    ""expectedControlType"": ""Button"",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
            ...
            ""bindings"": [
                ...
                {
                    ""name"": """",
                    ""id"": ""6adc3638-3b82-455e-b2fa-efe1fe28f116"",
                ...
                {
                    ""name"": """",
                    ""id"": ""d1d920bc-3fcb-4981-adf7-097508aaecd1"",
                    ""path"": ""<Keyboard>/p"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
    ...
    ~@OurInputs()
    {
        Debug.Assert(!m_Core.enabled, "This will cause a leak and performance issues, OurInputs.Core.Disable() has not been called.");
    }
