...
public class FSMachine : FSMState
{
    ...
    public FSMachine(FSMState startingState, bool debug = false, string stateName = "SFM", bool resetOnEnter = true, Action enter = null, Action exit = null) : base(stateName, enter, null, exit)
    {
